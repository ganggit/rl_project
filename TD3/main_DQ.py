...
if __name__ == "__main__":
    ...
    parser.add_argument("--env_name", default='Ant-v2')#'BipedalWalker-v3')
    ...
    while total_timesteps < args.max_timesteps:
        ...
        #     with open("td3_bipedal.pickle", 'wb') as handle:
        #         pickle.dump(dataSaved, handle)

        if(total_timesteps > 100000):
            with open("td3_"+args.env_name+"_seed"+str(args.seed)+".pickle", 'wb') as handle:
                pickle.dump(dataSaved, handle)
